!function() {
    function a(a, b, c) {
        return this.svg = m.select(a).append("svg").attr("width", c || a.offsetWidth).attr("data-width", c || a.offsetWidth).attr("class", "datamap").attr("height", b || a.offsetHeight).style("overflow", "hidden"),
        this.options.responsive && (m.select(this.options.element).style({
            position: "relative",
            "padding-bottom": "60%"
        }),
        ...
        m.select(this.options.element).select("svg").select("g").selectAll("path").style("vector-effect", "non-scaling-stroke")),
        this.svg
    }
    function b(a, b) {
        var c, d, e = b.width || a.offsetWidth, f = b.height || a.offsetHeight, g = this.svg;
        return b && "undefined" == typeof b.scope && (b.scope = "world"),
        "usa" === b.scope ? c = m.geo.albersUsa().scale(e).translate([e / 2, f / 2]) : "world" === b.scope && (c = m.geo[b.projection]().scale((e + 1) / 2 / Math.PI).translate([e / 2, f / ("mercator" === b.projection ? 1.45 : 1.8)])),
    ...
    function d(a) {
        ...
        g.enter().append("path").attr("d", this.path).attr("class", function(a) {
            ...
            var d;
            return c[a.id] && (d = b[c[a.id].fillKey]),
            d || b.defaultFill
    ...
    function e() {
        ...
        (d.highlightOnHover || d.popupOnHover) && b.selectAll(".datamaps-subunit").on("mouseover", function(e) {
            ...
            if (d.highlightOnHover) {
                ...
                f.style("fill", d.highlightFillColor).style("stroke", d.highlightBorderColor).style("stroke-width", d.highlightBorderWidth).style("fill-opacity", d.highlightFillOpacity).attr("data-previousAttributes", JSON.stringify(g)),
    ...
    function f(a, b) {
        ...
        this.options.fills) {
            ...
            for (var e in this.options.fills) {
                ...
                c += "<dt>" + d + "</dt>",
                c += '<dd style="background-color:' + this.options.fills[e] + '">&nbsp;</dd>'
            }
            c += "</dl>",
            m.select(this.options.element).append("div").attr("class", "datamaps-legend").html(c)
        }
    }
    function g() {
    ...
    function i(a, b) {
        ...
        this.svg.selectAll(".datamaps-subunit").attr("data-foo", function(e) {
            ...
            return a.append("text").attr("x", i).attr("y", j).style("font-size", (b.fontSize || 10) + "px").style("font-family", b.fontFamily || "Verdana").style("fill", b.labelColor || "#000").text(e.id),
            "bar"
        })
    }
    function j(a, b, c) {
        ...
        h.enter().append("svg:circle").attr("class", "datamaps-bubble").attr("cx", function(a) {
            var b;
            return d(a) ? b = e.latLngToXY(a.latitude, a.longitude) : a.centered && (b = e.path.centroid(g.select("path." + a.centered).data()[0])),
            b ? b[0] : void 0
        }).attr("cy", function(a) {
            var b;
            return d(a) ? b = e.latLngToXY(a.latitude, a.longitude) : a.centered && (b = e.path.centroid(g.select("path." + a.centered).data()[0])),
    ...
    function l(b) {
        ...
        return this.options = k(b, o),
        this.options.geographyConfig = k(b.geographyConfig, o.geographyConfig),
        this.options.projectionConfig = k(b.projectionConfig, o.projectionConfig),
        this.options.bubblesConfig = k(b.bubblesConfig, o.bubblesConfig),
        this.options.arcConfig = k(b.arcConfig, o.arcConfig),
        m.select(this.options.element).select("svg").length > 0 && a.call(this, this.options.element, this.options.height, this.options.width),
        this.addPlugin("bubbles", j),
        this.addPlugin("legend", f),
        this.addPlugin("arc", h),
        this.addPlugin("labels", i),
        this.addPlugin("graticule", g),
    ...
    l.prototype.draw = function() {
        function a(a) {
            ...
            d.call(b, a),
            e.call(b),
            (b.options.geographyConfig.popupOnHover || b.options.bubblesConfig.popupOnHover) && (hoverover = m.select(b.options.element).append("div").attr("class", "datamaps-hoverover").style("z-index", 10001).style("position", "absolute")),
            b.options.done(b)
        }
        var b = this
          , c = b.options
        ...
        c.geographyConfig.dataUrl ? m.json(c.geographyConfig.dataUrl, function(c, d) {
            if (c)
                throw new Error(c);
            b.customTopo = d,
            a(d)
    ...
    l.prototype.usaTopo = "__USA__",
    l.prototype.latLngToXY = function(a, b) {
    ...
    l.prototype.updateChoropleth = function(a) {
        ...
        for (var c in a)
            if (a.hasOwnProperty(c)) {
                ...
                e === Object(e) && (this.options.data[c] = k(e, this.options.data[c] || {}),
    ...
    "function" == typeof define && define.amd ? define("datamaps", function(a) {
        ...
        n = a("topojson"),
        l
    }) : window.Datamap = window.Datamaps = l,
